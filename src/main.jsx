...
function Ranking({show}){
  ...
  return (
    <div className="ranking-page">
      ...
      <aside className="ranking-prize-card side-card">
        <div className="side-title">
          <span>🏆 Premiação do ranking</span>
        </div>

        <div className="ranking-prize-highlight">
          <span>Valor líquido para premiação</span>
          <strong>R$ {premiacao.liquido.toFixed(2)}</strong>
        </div>

        <div className="ranking-prize-row first">
          <span>🥇 1º lugar</span>
          <strong>R$ {premiacao.primeiro.toFixed(2)}</strong>
          <small>70%</small>
        </div>

        <div className="ranking-prize-row second">
          <span>🥈 2º lugar</span>
          <strong>R$ {premiacao.segundo.toFixed(2)}</strong>
          <small>20%</small>
        </div>

        <div className="ranking-prize-row third">
          <span>🥉 3º lugar</span>
          <strong>R$ {premiacao.terceiro.toFixed(2)}</strong>
          <small>10%</small>
        </div>
...
function Dashboard({show, user, profile, goRanking}){
  ...
  <div className="prize-champion-box">
    ...
    <strong>R$ {premiacao.primeiro.toFixed(2)}</strong>
    <small>70% da premiação líquida</small>
  </div>
...
function calcularPremiacao(totalParticipantes, valor, taxa) {
  ...
  return {
    ...
    taxaValor,
    liquido,
    primeiro: liquido * 0.70,
    segundo: liquido * 0.20,
    terceiro: liquido * 0.10
  };
}
