  ...
  async function gerarPix() {
    ...
    const { data: atualizado, error } = await supabase
      ...
      .update({
        ...
        pix_copia_cola: data.qr_code || null
      })
      .eq('id', user.id)
      .select('*')
      .maybeSingle();
    ...
    show('Pix gerado com sucesso. Após o pagamento, aguarde a confirmação.');
  }
    ...
    <section className="panel profile-panel">
      <div className="panel-head">
        <div>
          ...
          <p>Gere seu Pix para confirmar a participação no bolão.</p>
        </div>
      </div>
      ...
      <div className="cards">
        <div className="kpi">
          <span>Status</span>
          <strong>{pagamentoConfirmado ? 'Confirmado' : 'Pendente'}</strong>
        </div>
        <div className="kpi">
          <span>Valor</span>
      ...
      {pagamentoPendente && (
        <div className="score-help" style={{ marginTop: 16 }}>
          Seus palpites serão liberados após a confirmação do pagamento pelo administrador ou pela integração automática.
        </div>
      )}
      ...
      {qrBase64 && (
        <div className="panel" style={{ marginTop: 16 }}>
          ...
          <img
            ...
            alt="QR Code Pix"
            style={{ maxWidth: 280, width: '100%', display: 'block', margin: '16px auto' }}
          />
          ...
          <textarea
            readOnly
            value={copiaCola || ''}
            style={{ width: '100%', minHeight: 120, padding: 12, borderRadius: 14, border: '1px solid #d6ded9' }}
          />
